...
from smac.optimizer.ei_optimization import InterleavedLocalAndRandomSearch, \
    AcquisitionFunctionMaximizer, ChooserNoCoolDown, ChooserLinearCoolDown
...
class SMAC(object):
    ...
    def _get_random_configuration_chooser(random_configuration_chooser):
        ...
        If random_configuration_chooser is falsy, initialize with ChooserNoCoolDown(1.0)
